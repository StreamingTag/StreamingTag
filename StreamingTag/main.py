...
if __name__ == '__main__':
    ...
    parser.add_argument("-j", "--json", help="the json file used to store slidingDTW results", default="")
    ...
    if ARGS.json == "" or not os.path.exists(ARGS.json):
    ...
    recorded_region_size = recorded_region_size // 2 * 2
    ...
    with open(ARGS.file, "r") as f:
        ...
        for line_index, line in enumerate(positions):
            ...
            print(f"Current line: frame_index={frame_index}")
            ...
            print(f"Corresponding frame in the pirated video: frame_index={recorded_frame_index}")
